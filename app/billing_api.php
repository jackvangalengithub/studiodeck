...
if($action==='billing'){
    ...
    json_response(['summary'=>billing_summary($u['studio_id']),'catalog'=>$catalog,'projects'=>$projects,'extra_projects'=>(int)$b['extra_projects'],'extra_seats'=>(int)$b['extra_seats'],'has_customer'=>(bool)$b['customer_id'],
