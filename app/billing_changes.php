...
function billing_change_preview(array $u,array $input): array {
    ...
    $oldLimits=billing_limits($current);$decrease=$catalog[$plan]['projects']+$ep<$oldLimits['projects']||$catalog[$plan]['seats']+$es<$oldLimits['seats']||$newCost<$oldCost;
