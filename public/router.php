...
if($path==='/' || $path==='/index.html' || preg_match('~^/[A-Za-z0-9_-]+/(?:projects(?:/[A-Za-z0-9_-]+)?|slide/[A-Za-z0-9_-]+|users|activity|comments|settings|profile)/?$~',$path)) { readfile(__DIR__.'/index.html');return; }
